...
/* package math-ex-0.1.0.0 */
#ifndef VERSION_math_ex
#define VERSION_math_ex "0.1.0.0"
#endif /* VERSION_math_ex */
#ifndef MIN_VERSION_math_ex
#define MIN_VERSION_math_ex(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_math_ex */
...
#define CURRENT_COMPONENT_ID "math-ex-0.1.0.0-inplace-math-ex"
